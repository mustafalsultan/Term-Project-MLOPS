...
```bash
2. Download the dataset from [Kaggle](https://www.kaggle.com/datasets/mlg-ulb/creditcardfraud?resource=download) and place the `creditcard.csv` file in the `data/` directory.
```
## Usage
